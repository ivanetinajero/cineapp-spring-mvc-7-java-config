			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-sm-9">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Udemy - Desarrollo Web con Spring Framework 7 & Spring Boot+Restful</h3>
							</div>
							<div class="panel-body">
								...
								QUE SERAS CAPAS DE DESARROLLAR AL FINALIZAR EL CURSO. POR LO TANTO PUEDES CREAR, ACTUALIZAR Y HASTA ELIMINAR REGISTROS.</div>
